...
export default function LandingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "helpem offers a free 30-day trial with 3,000 AI interactions. After that: Free plan (100 messages/month), Basic at $4.99/month (3,000 messages), and Premium at $9.99/month (7,500 messages). All plans include premium voice, smart organization, tribes, and voice + text input."
    },
    {
      ...
      <section id="how-it-works" className="py-16 sm:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-5xl font-bold text-brandText mb-4">Simple as 1-2-3</h2>
            <p className="text-lg text-brandTextLight">Getting started takes seconds</p>
          </div>
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-12">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-brandText mb-3">AI Organizes</h3>
              <p className="text-brandTextLight leading-relaxed">
                helpem instantly categorizes it as a todo, appointment, routine, or grocery. No manual sorting needed.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-brandBlue to-brandGreen flex items-center justify-center text-3xl font-bold text-white mx-auto mb-6">
