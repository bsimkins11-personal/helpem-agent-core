...
export default function AppPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* DIV 2: Welcome Banner - Fixed at 60px (header height) */}
      ...
      {/* DIV 3: Type/Hold to Talk Buttons - Fixed at 105px (after banner) */}
      <div className="fixed top-[105px] left-0 right-0 z-50">
      ...
      {/* DIV 4: Content Modules - Scrollable, starts at 155px (after buttons) */}
      <div className="pt-[155px] bg-gray-50">
