...
export default function AppPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed top-[120px] left-0 right-0 z-50 bg-gray-50 border-b-4 border-gray-400 shadow-lg">
        <div className="bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 md:px-6 pb-3">
            <div className="flex items-center gap-2 bg-white p-2.5 rounded-lg shadow-sm">
            <button
              onClick={() => {
                setInputMode("type");
                scrollToChat();
      ...
      <div className="pt-[190px] bg-gray-50">
