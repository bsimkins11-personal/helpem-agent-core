...
export default function AppPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
      {/* Tribe Invite Notification */}
      {showInviteNotification && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 z-[100001] max-w-md w-full px-4 animate-fade-in">
          <div className="bg-purple-600 text-white p-4 rounded-xl shadow-2xl">
            <div className="flex items-center gap-3">
              <div className="flex-shrink-0 w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                <span className="text-xl">👥</span>
              </div>
              <div className="flex-1">
                <h3 className="font-bold mb-1">Welcome to your tribe!</h3>
                <p className="text-sm text-white/90">Opening your tribes now...</p>
              </div>
            </div>
          </div>
        </div>
